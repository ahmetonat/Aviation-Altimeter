...
#define SSD1306_ADDR 0x78      //Full 8 bit address, justified left.
        //If you change the address in hardware, change ths value also.
...
uint8_t u8g_com_hw_i2c_fn(u8g_t *u8g, uint8_t msg, uint8_t arg_val, void *arg_ptr) { 
  ...
  case U8G_COM_MSG_INIT:
    ...
    //I2C_LowLevel_Init(I2C2, 120000, 0);  //Works OK.
    //I2C_LowLevel_Init(I2C2, 150000, 0);  //Too fast. Screen does not work.
    I2C_LowLevel_Init(I2C2, 140000, 0);    //Works OK.
    delay_init();
